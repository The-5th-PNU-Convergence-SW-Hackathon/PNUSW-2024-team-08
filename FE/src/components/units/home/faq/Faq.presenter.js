    ...
    <>
      <S.WrapperFaq>
        <S.FaqContentsContainer>
          ...
          <S.FaqDetail>
            신분증, 거주증명서 등 필요 서류를 제출하고, 수수료를
            <br />
            지불해요. 수수료는 동물 종류나 상태에 따라 달라요.
            <br />
        ...
        <S.FaqContentsContainer style={{ marginTop: "40px" }}>
          ...
          <S.FaqDetail>
            포포는 입양 동물에게 기본적인 예방접종을
            <br />
            시행하고 있어요. 그래도 입양 전에 건강 상태를 확인하고,
            <br />
        ...
        <S.FaqContentsContainer style={{ marginTop: "40px" }}>
          ...
          <S.FaqDetail>
            네, 물론이죠! 포포 어플의 커뮤니티를 통해 입양 경험을
            <br />
            공유하고, 질문을 통해 궁금증을 해결하거나 사진을 통해
            <br />
        ...
        <S.FaqContentsContainer style={{ marginTop: "40px" }}>
          ...
          <S.FaqDetail>
            입양을 취소하고 싶다면 보호소나 입양기관에 연락해서
            <br />
            상황을 설명해야 해요. 하지만 입양 결정과 마찬가지도
            <br />
        ...
        <S.NextButtonBlock>
          <S.NextButtonItem onClick={props.navigateTo("/community/question")}>
            질문하러 가기
          </S.NextButtonItem>
        </S.NextButtonBlock>
      </S.WrapperFaq>
