...
- 결론</br>
  > 다양한 채널을 활용하여 서비스 인지도를 제고하고, 표준화된 프로세스의 시스템 개발로 효율성을 높여야 한다. </br>
  
  > 동물 복지 정책 및 지원 사업과 연계하여 시너지 효과를 창출하고, 정부 및 지자체의 정책 변화에 능동적으로 대응해야 한다. </br>
</br>

####  □ 기대 효과</br>
포포가 지속 가능한 사회적 서비스로서 반려동물 문화의 발전을 선도하기를 기대한다.</br>

- 입양 활성화</br>
  > 유기동물에 대한 관심을 높여 유기동물 보호소 지원 및 입양 활성화 기대</br>
- 법령 제정</br>
  > 유기동물 문제 해결을 위한 법령 제정 및 정비 기대</br>
- 동물 복지 증진</br>
  > 지역사회의 관심과 참여자 증대를 통한 유기동물의 생활 환경 개선과 동물 복지 증진 기대</br>
- 지역사회 기여</br>
  > 반려동물과의 공존을 통해 만들어가는 아름답고 조화로운 지역사회를 기대</br>
</br>
...
| 분류                | 기능1                                      | 기능2                                                          |
|-----------------------|----------------------------------------|--------------------------------------------------------------|
| 봉사활동     | 동물의 건강 상태, 성격 등 동물에 대한 신뢰할 수 있는 정보를 제공받아야 한다.  |              |
| 입양        | 복잡하지 않고 직관적인 입양 신청 과정을 통해, 신청을 간편하게 할 수 있어야 한다.  |              |
| 커뮤니티           | 사용자의 현재 위치를 기반으로, 가까운 보호소를 쉽게 검색할 수 있어야 한다.      |            |
| 채팅         | 복잡하지 않고 직관적인 입양 신청 과정을 통해, 신청을 간편하게 할 수 있어야 한다.  |                 |
...
#### 3.3. 기능명세서
> ForPaw에는 현재 114개의 API가 구현되어 있으며, 자세한 내용은 분량상 네이버 블로그에 정리해두었습니다. </br>
